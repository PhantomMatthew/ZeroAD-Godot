...
{
    /// <summary>当前格式版本。v23: ResourceGatherer 增 GatherAcc 尾段(小数采集累计;
    /// v22 及更早档读 0)。v22: VisionSharing 组件(间谍/驻军视野共享;pre-v22 档
    /// 无此组件段,由 RegisterForLos 冷加载按模板补挂)+ StatisticsTracker 增贿赂计数
    /// 尾段(更早的档读 0)。v21: VictoryManager 关键实体增 GarrisonEmergency
    ...
    /// Route 尾段。</summary>
    public const uint CurrentVersion = 23;
