...
public static class SaveGameManager
{
    ...
    private const uint Version = 16; // v16: UnitMotion waypoints 定点序列化(读档续走) // v15: 转向物理 // v14: UnitMotion 增推挤 Weight // v13: 槽位增 AI 难度/性格 // v12: AIComponent 增 HQ 尾段(AI 计划/队列/攻防军/运输骑缝)
